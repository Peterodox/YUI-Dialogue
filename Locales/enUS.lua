...
L["TTS Skip Recent"] = "Skip Recent Texts";
L["TTS Skip Recent Desc"] = "Skip recently readed texts if Auto Play is enabled.";
L["TTS Auto Stop"] = "Stop When Leaving";
L["TTS Auto Stop Desc"] = "Stop reading when you leave the NPC.";
L["TTS Stop On New"] = "Stop When Opening Dialog";
L["TTS Stop On New Desc"] = "Stop reading when you open new dialog.";
...
L["TTS Use Narrator Desc"] = "Use narrating voice to read speaker name, quest title, objectives and any text in <> braces:";
L["TTS Voice Narrator"] = "Narrator Voice";
