...
L["Gossip"] = "Charla";
L["Theme"] = "Tema";
L["Theme Desc"] = "Selecciona un tema de color para la IU.";
L["Theme Brown"] = "Marrón";
L["Theme Dark"] = "Oscuro";
L["Frame Size"] = "Tamaño de la ventana";
L["Frame Size Desc"] = "Establece el tamaño de la interfaz.\n\nPor defecto: Mediano";
...
L["Frame Orientation Desc"] = "Coloca la IU a la izquierda o derecha de la pantalla";
...
L["Simplify Currency Rewards Desc"] = "Utilizar iconos más pequeños para las recomendas de Monedas y ocultar sus nombres.";
...
L["Disable Camera Movement Instance"] = "Desactivar en Estancia";
...
L["Input Device"] = "Dispotivo de entrada";
...
L["Press Button To Scroll Down Desc"] = "Si el contenido es más alto que lal ventana, presionar el botón de confirmación deslizará verticalmente la página hacia abajo en vez de aceptar la misión.";
...
L["TTS Use Hotkey Desc"] = "Inicia o parala lectura presioando:";
...
L["TTS Auto Play"] = "Automático";
L["TTS Auto Play Desc"] = "Iniciar automáticamente textos de diálogo.";
L["TTS Auto Stop"] = "Parar al salir";
L["TTS Auto Stop Desc"] = "Para la lectura cuando abandonas al PNJ.";
