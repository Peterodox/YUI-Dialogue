...
L["Press Key To Open Container"] = "按键打开宝箱";
L["Press Key To Open Container Desc PC"] = "非战斗时按 [KEY:PC:SPACE] 打开宝箱。";
L["Press Key To Open Container Desc Xbox"] = "非战斗时按 [KEY:XBOX:PAD3] 打开宝箱。";
L["Press Key To Open Container Desc PlayStation"] = "非战斗时按 [KEY:PS:PAD3] 打开宝箱。";
L["Press Key To Open Container Desc Switch"] = "非战斗时按 [KEY:SWITCH:PAD3] 打开宝箱。";
L["Auto Select"] = "自动选择";
