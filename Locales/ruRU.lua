...
L["Press Key To Open Container"] = "Использовать клавишу для открытия контейнера";
L["Press Key To Open Container Desc PC"] = "Нажмите [KEY:PC:SPACE], чтобы открыть контейнер с наградами, когда вы находитесь вне боя.";
L["Press Key To Open Container Desc Xbox"] = "Нажмите [KEY:XBOX:PAD3], чтобы открыть контейнер с наградами, когда вы находитесь вне боя.";
L["Press Key To Open Container Desc PlayStation"] = "Нажмите [KEY:PS:PAD3], чтобы открыть контейнер с наградами, когда вы находитесь вне боя.";
L["Press Key To Open Container Desc Switch"] = "Нажмите [KEY:SWITCH:PAD3], чтобы открыть контейнер с наградами, когда вы находитесь вне боя.";
