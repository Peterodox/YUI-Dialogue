...
L["Quest Auto Accepted Tooltip"] = "Этот квест автоматически принимается игрой.";
...
L["Gossip"] = "Разговор";
L["Theme"] = "Тема";
L["Theme Desc"] = "Выберите цветовую тему для интерфейса.";
...
L["Hide UI Desc"] = "Скрыть пользовательский интерфейс игры, когда вы взаимодействуете с NPC.";
...
L["Show Quest Type Text"] = "Показать тип квеста";
L["Show Quest Type Text Desc"] = "Показывать тип квеста справа от него.\n\nПростые задания всегда помечены.";
...
L["Force Gossip"] = "Форсировать диалог";
...
L["Input Device Xbox Tooltip"] = "Кнопка подтверждения: [KEY:XBOX:PAD1]\nКнопка отмены: [KEY:XBOX:PAD2]";
L["Input Device PlayStation"] = "PlayStation";
L["Input Device PlayStation Tooltip"] = "Кнопка подтверждения: [KEY:PS:PAD1]\nКнопка отмены: [KEY:PS:PAD2]";
