...
L["TTS Button Tooltip"] = "Левый клик: Воспроизведение/Остановка чтения.\nПравый клик: Переключение автоматического воспроизведения";
...
L["TTS Use Hotkey Desc"] = "Начать или остановить озвучивание текста, нажав эту клавишу:";
