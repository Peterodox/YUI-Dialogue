...
L["TTS"] = "Текст в речь";
L["TTS Desc"] = "Озвучивание диалоговых текстов";
L["TTS Trigger None"] = "Нет";
L["TTS Trigger None Tooltip"] = "Нажмите кнопку в левом верхнем углу диалога, чтобы озвучить текст.";
L["TTS Trigger Button Tooltip"] = "Начать или остановить озвучивание текста, нажав эту кнопку: "; -- space
L["TTS Trigger Button PC"] = "[KEY:PC:R]";
L["TTS Trigger Auto"] = "Автоозвучивание";
L["TTS Trigger Auto Tooltip"] = "Автоматическое озвучивание текстов диалогов.";
