...
local FONT_OBJECT_HEIGHT = {
    ...
    DUIFont_Quest_Title_18 = {18, 18, 18},
    DUIFont_Quest_Title_16 = {16, 16, 16},
    DUIFont_Quest_SubHeader = {12, 14, 16},
    DUIFont_Quest_Paragraph = {12, 14, 16},
    DUIFont_Quest_Gossip = {12, 14, 16},
    DUIFont_Quest_Quest = {12, 14, 16},
    DUIFont_Quest_Disabled = {12, 14, 16},

    DUIFont_Settings_Disabled = {12, 14, 16},

    DUIFont_Item = {10, 12, 12},
    DUIFont_ItemSelect = {10, 12, 12},

    DUIFont_Hotkey = {10, 12, 12},

    DUIFont_QuestType_Left = {10, 12, 12},
    DUIFont_QuestType_Right = {10, 12, 12},

    DUIFont_Tooltip_Large = {12, 14, 16},
    DUIFont_Tooltip_Medium = {10, 12, 12},
    DUIFont_Tooltip_Small = {10, 12, 12},
...
function ThemeUtil:SetFontSizeByID(id)
    ...
    if id == DEFAULT_FONT_SIZE then return end;
    ...
    for fontName, v in pairs(FONT_OBJECT_HEIGHT) do
        ...
        _G[fontName]:SetFont(fontFile, v[id], flags);
    end
