...
do
    ...
    local LOCALE_KEYS = {
        ...
        ["Press Key To Open Container Desc PC"] = SETTINGS_DESC_SPACING,
        ["Press Key To Open Container Desc Xbox"] = SETTINGS_DESC_SPACING,
        ["Press Key To Open Container Desc PlayStation"] = SETTINGS_DESC_SPACING,
        ["Press Key To Open Container Desc Switch"] = SETTINGS_DESC_SPACING,
